...
extension UIView {
    ...
    //    func GradiantColor(topColor: UIColor, bottomColor:  UIColor,  contentView: UIView) {
    //        let gradiantLayer = CAGradientLayer()
    //        gradiantLayer.colors = [topColor , bottomColor]
    //        gradiantLayer.locations = [1.0, 0.0]
    //        gradiantLayer.frame = bounds
    //        contentView.layer.insertSublayer(gradiantLayer, at: 0)
    //    }
